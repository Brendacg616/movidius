...
#ifndef ACTION_DETECTOR_H
#define ACTION_DETECTOR_H
...
struct ActionDetectorConfig  {
    ...
    float detection_confidence_threshold = 0.15f;
    /** @brief Threshold for recognized actions */
    float action_confidence_threshold = 0.3f;
...
public:
    ...
    void fetchResults(InferRequest::Ptr request);
